...
min_grammar <- ifelse(min==1, "minute", "minutes")
sec_grammar <- ifelse(sec==1, "second", "seconds")

cat(paste0(var_seconds, " seconds is ", min, " ", min_grammar, 
           " and ", sec, " ", sec_grammar, "."), "\n")
```
...
for (i in 2:(q6-1)){
  if (q6 %% i == 0){
    print(paste(q6, "is not a prime number."))
  }
  else{
    print(paste(q6, "is a prime number."))
    break
  }
}
```
...
sprintf("%d squared is %d, and is the first number whose square exceeds %d.", n, n^2, q7)
```
